...
/*
  PresentationCode receives a XXXXX code at constructor, all must be digits
...
PresentationCode i("1234");

TEST(PresentationCodeTestTest, TestingReturns) {
    EXPECT_EQ("1234", i.getPresentationCode());
}
